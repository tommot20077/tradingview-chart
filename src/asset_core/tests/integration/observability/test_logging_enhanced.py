...
class TestLogContextPropagation:
    ...
    def test_log_context_propagation_across_functions(self):
    ...
    async def test_log_context_propagation_across_async_boundaries(self):
    ...
    def test_log_context_nesting_and_restoration(self):
...
class TestLogFilteringRules:
    ...
    def test_custom_filter_functionality(self):
    ...
    def test_combined_level_and_custom_filtering(self):
...
class TestAsyncLoggingPerformance:
    ...
    async def test_async_logging_non_blocking(self):
        ...
        async def heavy_logging_task(task_id: int, message_count: int):
    ...
    async def test_async_logging_with_exceptions(self):
...
class TestLogSanitization:
    ...
    def test_pii_data_redaction(self):
        ...
        def pii_redaction_filter(record):
            import re
    ...
    def test_custom_sensitive_pattern_masking(self):
        ...
        def custom_pattern_filter(record):
            import re
