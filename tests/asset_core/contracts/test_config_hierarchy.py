...
class TestConfigurationHierarchy:
    ...
    def test_multiple_config_inheritance(self) -> None:
    ...
    def test_selective_config_inheritance(self) -> None:
    ...
    def test_config_field_precedence_in_inheritance(self) -> None:
    ...
    def test_extended_config_validation_enhancement(self) -> None:
    ...
    def test_cross_config_environment_variable_loading(self) -> None:
    ...
    def test_config_serialization_with_inheritance(self) -> None:
    ...
    def test_config_method_inheritance(self) -> None:
    ...
    def test_config_validation_error_aggregation(self) -> None:
    ...
    def test_diamond_inheritance_resolution(self) -> None:
    ...
    def test_configuration_composition_vs_inheritance(self) -> None:
        ...
        class ComposedAppConfiguration:
            ...
            def is_production(self) -> bool:
                return bool(self.core.is_production())
