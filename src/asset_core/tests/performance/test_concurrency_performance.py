...
class TestConcurrencyPerformance:
    ...
    async def test_async_operation_overhead(
        ...
        assert async_concurrent_time < async_seq_time * 0.5  # Expect at least 2x speedup for many tasks
        ...
        async def validate_model_async(model: Trade) -> bool:
            ...
            return model.price > 0  # Simple validation
        ...
        assert validation_time < async_seq_time * 0.5  # Expect speedup for concurrent validation
