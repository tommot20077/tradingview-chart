...
class TestBaseNetworkConfigConstruction:
    ...
    def test_default_network_config_creation(self) -> None:
    ...
    def test_custom_network_config_creation(self) -> None:
    ...
    def test_network_config_from_dict(self) -> None:
...
class TestBaseNetworkConfigEnvironmentVariables:
    ...
    def test_env_var_loading_reconnect_interval(self) -> None:
    ...
    def test_env_var_loading_max_reconnect_attempts(self) -> None:
    ...
    def test_env_var_loading_ping_interval(self) -> None:
    ...
    def test_env_var_loading_ping_timeout(self) -> None:
...
class TestBaseNetworkConfigValidation:
    ...
    def test_non_integer_values_rejected(self) -> None:
...
class TestBaseNetworkConfigBoundaryValues:
    ...
    def test_realistic_websocket_values(self) -> None:
...
class TestBaseNetworkConfigEdgeCases:
    ...
    def test_timeout_vs_interval_relationships(self) -> None:
...
class TestBaseNetworkConfigInvalidData:
    ...
    def test_invalid_string_integers(self) -> None:
    ...
    def test_bool_values_converted_to_int(self) -> None:
...
class TestBaseNetworkConfigIntegration:
    ...
    def test_complete_network_configuration(self) -> None:
    ...
    def test_websocket_configuration_realism(self) -> None:
