...
class TestKlineConstruction:
    ...
    def test_valid_kline_creation(self, sample_kline: Kline) -> None:
...
class TestKlineCalculatedProperties:
    ...
    def test_duration_calculation(self, sample_kline: Kline) -> None:
...
class TestKlineSerialization:
    ...
    def test_to_dict_conversion(self, sample_kline: Kline) -> None:
        """Test to_dict method.
    ...
    def test_model_dump_json_serializable(self, sample_kline: Kline) -> None:
...
class TestKlineStringRepresentation:
    ...
    def test_string_representation(self, sample_kline: Kline) -> None:
