...
class TestBaseCoreSettingsEdgeCases:
    ...
    def test_extra_fields_ignored(self) -> None:
        ...
        settings = BaseCoreSettings(app_name="test", unknown_field="should_be_ignored")  # type: ignore[call-arg]
...
class TestBaseCoreSettingsInvalidData:
    ...
    def test_none_values_for_required_fields(self) -> None:
        ...
        with pytest.raises(ValidationError) as exc_info:
            BaseCoreSettings(app_name=None, environment=None, debug=None)  # type: ignore
